...
`),r=new Blob([n],{type:"text/csv;charset=utf-8;"});this.downloadFile(r,"660_questions.csv")},downloadFile(t,e){const n=URL.createObjectURL(t),r=document.createElement("a");r.href=n,r.download=e,document.body.appendChild(r),r.click(),document.body.removeChild(r),URL.revokeObjectURL(n)},getDifficultyPercentage(t){const e=Math.max(...Object.values(this.difficultyStats));return e>0?this.difficultyStats[t]/e*100:0},openNoteModal(t){this.currentQuestionNumber=t;const e=this.questions.find(n=>n.number===t);this.currentNote=e&&e.note||"",this.showNoteModal=!0},saveNote(){if(this.currentQuestionNumber){const t=this.questions.find(e=>e.number===this.currentQuestionNumber);t&&(t.note=this.currentNote,this.saveData(),this.showNoteModal=!1)}},renderMarkdown(t){return t?Wx.render(t):""},clearAllData(){if(confirm("确定要清除当前用户的所有数据吗？此操作无法恢复！"))try{this.usersData.currentUser&&this.usersData.users[this.usersData.currentUser]&&(this.usersData.users[this.usersData.currentUser].data.questions=this.initializeDefaultQuestions(),this.questions=this.initializeDefaultQuestions(),this.saveUsersData()),this.showClearDataModal=!1,console.log("数据清除成功"),alert("数据已成功清除")}catch(t){console.error("清除数据失败:",t),alert("清除数据失败，请重试")}},createUser(){if(this.newUserName.trim()){const t="user_"+Date.now();this.usersData.users[t]={name:this.newUserName.trim(),createdAt:Date.now(),data:{version:this.dataVersion,timestamp:Date.now(),questions:this.initializeDefaultQuestions()}},this.usersData.currentUser=t,this.loadUserData(),this.saveUsersData(),this.newUserName="",this.showUserModal=!1,console.log("用户创建成功")}else alert("请输入用户名")},switchUser(t){const e=t.target.value;this.usersData.users[e]&&(this.usersData.currentUser=e,this.loadUserData(),this.saveUsersData(),console.log("用户切换成功"))},deleteUser(t){if(confirm("确定要删除此用户吗？此操作无法恢复！"))if(Object.keys(this.usersData.users).length>1){if(delete this.usersData.users[t],this.usersData.currentUser===t){const e=Object.keys(this.usersData.users);e.length>0&&(this.usersData.currentUser=e[0],this.loadUserData())}this.saveUsersData(),console.log("用户删除成功")}else alert("至少需要保留一个用户")},editUser(t){this.editingUserId=t,this.editingUserName=this.usersData.users[t].name,this.showEditUserModal=!0},saveEditUser(){this.editingUserName.trim()&&this.editingUserId?(this.usersData.users[this.editingUserId].name=this.editingUserName.trim(),this.saveUsersData(),this.showEditUserModal=!1,this.editingUserId=null,this.editingUserName="",console.log("用户编辑成功")):alert("请输入用户名")},async handleLogin(){this.authLoading=!0,this.authError="";try{const t=await Bx(this.authForm.email,this.authForm.password);$a(t.user,t.token),this.showAuthModal=!1,this.authForm={email:"",password:"",username:""},this.syncData(),console.log("登录成功")}catch(t){this.authError=t,console.error("登录失败:",t)}finally{this.authLoading=!1}},async handleRegister(){this.authLoading=!0,this.authError="";try{const t=await Ux(this.authForm.username,this.authForm.email,this.authForm.password);$a(t.user,t.token),this.showRegisterModal=!1,this.authForm={email:"",password:"",username:""},this.syncData(),console.log("注册成功")}catch(t){this.authError=t,console.error("注册失败:",t)}finally{this.authLoading=!1}},async handleLogout(){try{await id(),console.log("登出成功")}catch(t){console.error("登出失败:",t)}},async syncData(){try{const t=await Hx();t&&t.questions&&(this.questions=t.questions,this.saveData(),console.log("同步成功"))}catch(t){console.error("同步失败:",t),alert("同步失败，请检查网络连接")}}}},Gx={class:"app"},Qx={class:"header"},Jx={class:"user-section"},Yx={class:"current-user"},Xx=["value"],Zx={key:1,class:"auth-user"},ek={class:"header-actions"},tk={key:0,class:"sync-status"},nk=["disabled"],rk={class:"analysis-section"},sk={class:"analysis-grid"},ik={class:"analysis-card"},ok={class:"progress-bar"},uk={class:"analysis-card"},ak={class:"status-stats"},ck={class:"stat-item"},lk={class:"stat-value",style:{color:"#4CAF50"}},hk={class:"stat-item"},fk={class:"stat-value",style:{color:"#FF9800"}},dk={class:"stat-item"},pk={class:"stat-value",style:{color:"#FF5722"}},mk={class:"stat-item"},gk={class:"stat-value",style:{color:"#F44336"}},_k={class:"stat-item"},yk={class:"stat-value",style:{color:"#9C27B0"}},bk={class:"analysis-card"},Ek={class:"difficulty-stats"},vk={class:"difficulty-label"},wk={class:"difficulty-bar"},Tk={class:"difficulty-count"},Ik={class:"analysis-card"},Ak={class:"photo-stats"},Ck={class:"stat-item"},xk={class:"stat-value"},kk={class:"stat-item"},Sk={class:"stat-value"},Dk={key:0,class:"analysis-card"},Rk={class:"sync-info"},Pk={class:"stat-item"},Fk={key:0,class:"stat-item"},Nk={class:"stat-value"},Ok=["disabled"],Vk={class:"analysis-card analysis-suggestions"},Mk={class:"suggestions"},Lk={key:0,class:"suggestion-item warning"},Uk={key:1,class:"suggestion-item warning"},Bk={key:2,class:"suggestion-item info"},qk={key:3,class:"suggestion-item success"},jk={key:4,class:"suggestion-item info"},zk={key:5,class:"suggestion-item success"},Hk={key:6,class:"suggestion-item success"},$k={key:7,class:"suggestion-item info"},Wk={class:"filter-section"},Kk={class:"search-box"},Gk={class:"filter-options"},Qk={class:"questions-grid"},Jk={class:"question-header"},Yk={class:"question-number"},Xk={class:"question-actions"},Zk=["onClick"],eS=["onClick"],tS=["onClick"],nS={class:"question-status"},rS=["onUpdate:modelValue"],sS={class:"question-difficulty"},iS={class:"difficulty-stars"},oS=["onClick"],uS={key:0,class:"question-note-preview"},aS=["innerHTML"],cS={key:0,class:"modal"},lS={class:"modal-content"},hS={class:"modal-header"},fS={key:0,class:"image-preview"},dS=["src"],pS={key:1,class:"modal"},mS={class:"modal-content preview-modal"},gS={class:"modal-header"},_S={class:"preview-area"},yS=["src"],bS={key:2,class:"modal"},ES={class:"modal-content note-modal"},vS={class:"modal-header"},wS={class:"note-editor"},TS={class:"note-actions"},IS={key:3,class:"modal"},AS={class:"modal-content"},CS={class:"modal-header"},xS={class:"note-actions"},kS={key:4,class:"modal"},SS={class:"modal-content user-modal"},DS={class:"modal-header"},RS={class:"user-management"},PS={class:"add-user"},FS={class:"user-list"},NS={class:"user-info"},OS={class:"user-name"},VS={key:0,class:"user-status"},MS={class:"user-actions"},LS=["onClick"],US=["onClick","disabled"],BS={key:5,class:"modal"},qS={class:"modal-content"},jS={class:"modal-header"},zS={class:"edit-user-content"},HS={class:"note-actions"},$S={key:6,class:"modal"},WS={class:"modal-content auth-modal"},KS={class:"modal-header"},GS={class:"auth-content"},QS={key:0,class:"error-message"},JS={class:"form-group"},YS={class:"form-group"},XS=["disabled"],ZS={class:"auth-switch"},eD={key:7,class:"modal"},tD={class:"modal-content auth-modal"},nD={class:"modal-header"},rD={class:"auth-content"},sD={key:0,class:"error-message"},iD={class:"form-group"},oD={class:"form-group"},uD={class:"form-group"},aD=["disabled"],cD={class:"auth-switch"};function lD(t,e,n,r,s,i){var o;return le(),he("div",Gx,[x("header",Qx,[x("div",Jx,[x("div",Yx,[i.isAuthenticated?(le(),he("div",Zx,[x("span",null,ye((o=i.currentAuthUser)==null?void 0:o.username),1),x("button",{onClick:e[2]||(e[2]=(...u)=>i.handleLogout&&i.handleLogout(...u)),class:"btn btn-sm"},"登出")])):Ct((le(),he("select",{key:0,"onUpdate:modelValue":e[0]||(e[0]=u=>s.usersData.currentUser=u),onChange:e[1]||(e[1]=(...u)=>i.switchUser&&i.switchUser(...u)),class:"user-select"},[(le(!0),he(Et,null,ui(i.users,(u,c)=>(le(),he("option",{key:c,value:c},ye(u.name),9,Xx))),128))],544)),[[So,s.usersData.currentUser]]),i.isAuthenticated?Ie("",!0):(le(),he("button",{key:2,onClick:e[3]||(e[3]=u=>s.showUserModal=!0),class:"btn btn-sm"},"管理用户"))])]),e[50]||(e[50]=x("h1",null,"26版660习题集记录",-1)),x("div",ek,[i.isAuthenticated?(le(),he("div",tk,[e[49]||(e[49]=x("span",{class:"sync-label"},"同步状态:",-1)),x("span",{class:Fr(["sync-indicator",s.syncStatus.value])},ye(i.syncStatusText),3),x("button",{onClick:e[4]||(e[4]=(...u)=>i.syncData&&i.syncData(...u)),class:"btn btn-sm",disabled:s.syncStatus.value==="syncing"}," 手动同步 ",8,nk)])):Ie("",!0),i.isAuthenticated?Ie("",!0):(le(),he("button",{key:1,onClick:e[5]||(e[5]=u=>s.showAuthModal=!0),class:"btn"},"登录")),i.isAuthenticated?Ie("",!0):(le(),he("button",{key:2,onClick:e[6]||(e[6]=u=>s.showRegisterModal=!0),class:"btn"},"注册")),x("button",{onClick:e[7]||(e[7]=u=>i.exportData("csv")),class:"btn"},"导出CSV"),x("button",{onClick:e[8]||(e[8]=u=>i.exportData("json")),class:"btn"},"导出JSON"),x("button",{onClick:e[9]||(e[9]=u=>s.showClearDataModal=!0),class:"btn btn-danger"},"清除数据")])]),x("div",rk,[x("div",sk,[x("div",ik,[e[51]||(e[51]=x("h3",null,"完成进度",-1)),x("div",ok,[x("div",{class:"progress-fill",style:Di({width:`${i.progressPercentage}%`})},null,4)]),x("p",null,ye(i.completedCount)+" / 660 题 ("+ye(i.progressPercentage.toFixed(1))+"%)",1)]),x("div",uk,[e[57]||(e[57]=x("h3",null,"状态分布",-1)),x("div",ak,[x("div",ck,[e[52]||(e[52]=x("span",{class:"stat-label"},"掌握:",-1)),x("span",lk,ye(i.statusStats.掌握)+" 题",1)]),x("div",hk,[e[53]||(e[53]=x("span",{class:"stat-label"},"粗心:",-1)),x("span",fk,ye(i.statusStats.粗心)+" 题",1)]),x("div",dk,[e[54]||(e[54]=x("span",{class:"stat-label"},"概念模糊:",-1)),x("span",pk,ye(i.statusStats.概念模糊)+" 题",1)]),x("div",mk,[e[55]||(e[55]=x("span",{class:"stat-label"},"没思路:",-1)),x("span",gk,ye(i.statusStats.没思路)+" 题",1)]),x("div",_k,[e[56]||(e[56]=x("span",{class:"stat-label"},"其他:",-1)),x("span",yk,ye(i.statusStats.其他)+" 题",1)])])]),x("div",bk,[e[58]||(e[58]=x("h3",null,"难度分布",-1)),x("div",Ek,[(le(),he(Et,null,ui(5,u=>x("div",{key:u,class:"difficulty-item"},[x("span",vk,ye(u)+"级:",1),x("div",wk,[x("div",{class:"difficulty-fill",style:Di({width:`${i.getDifficultyPercentage(u)}%`})},null,4)]),x("span",Tk,ye(i.difficultyStats[u])+" 题",1)])),64))])]),x("div",Ik,[e[61]||(e[61]=x("h3",null,"照片统计",-1)),x("div",Ak,[x("div",Ck,[e[59]||(e[59]=x("span",{class:"stat-label"},"已上传照片:",-1)),x("span",xk,ye(i.photoCount)+" 题",1)]),x("div",kk,[e[60]||(e[60]=x("span",{class:"stat-label"},"照片覆盖率:",-1)),x("span",Sk,ye(i.photoPercentage.toFixed(1))+"%",1)])])]),i.isAuthenticated?(le(),he("div",Dk,[e[64]||(e[64]=x("h3",null,"云端同步",-1)),x("div",Rk,[x("div",Pk,[e[62]||(e[62]=x("span",{class:"stat-label"},"同步状态:",-1)),x("span",{class:Fr(["stat-value","sync-"+s.syncStatus.value])},ye(i.syncStatusText),3)]),s.lastSyncTime.value?(le(),he("div",Fk,[e[63]||(e[63]=x("span",{class:"stat-label"},"上次同步:",-1)),x("span",Nk,ye(i.formatSyncTime(s.lastSyncTime.value)),1)])):Ie("",!0),x("button",{onClick:e[10]||(e[10]=(...u)=>i.syncData&&i.syncData(...u)),class:"btn btn-sm",disabled:s.syncStatus.value==="syncing",style:{"margin-top":"10px"}}," 立即同步 ",8,Ok)])])):Ie("",!0),x("div",Vk,[e[65]||(e[65]=x("h3",null,"学习建议",-1)),x("div",Mk,[i.statusStats.没思路>0?(le(),he("div",Lk," ⚠️ 有 "+ye(i.statusStats.没思路)+' 道题"没思路"，建议重点复习相关知识点 ',1)):Ie("",!0),i.statusStats.概念模糊>0?(le(),he("div",Uk," ⚠️ 有 "+ye(i.statusStats.概念模糊)+' 道题"概念模糊"，需要加强基础概念理解 ',1)):Ie("",!0),i.statusStats.粗心>0?(le(),he("div",Bk," 💡 有 "+ye(i.statusStats.粗心)+' 道题"粗心"，做题时请更加仔细 ',1)):Ie("",!0),i.statusStats.掌握>50?(le(),he("div",qk," 🎉 已掌握 "+ye(i.statusStats.掌握)+" 道题，继续保持！ ",1)):Ie("",!0),i.completedCount===0?(le(),he("div",jk," 📚 还没有开始做题，建议从简单题目开始 ")):Ie("",!0),i.progressPercentage>=80?(le(),he("div",zk," 🏆 完成度超过80%，非常棒！ ")):Ie("",!0),i.averageDifficulty>=4&&i.completedCount>0?(le(),he("div",Hk," 💪 平均难度达到"+ye(i.averageDifficulty.toFixed(1))+"级，挑战能力很强！ ",1)):Ie("",!0),i.photoCount<i.completedCount*.5&&i.completedCount>10?(le(),he("div",$k," 📷 建议多上传错题照片，便于复习 ")):Ie("",!0)])])])]),x("div",Wk,[x("div",Kk,[Ct(x("input",{type:"number","onUpdate:modelValue":e[11]||(e[11]=u=>s.searchNumber=u),placeholder:"输入题号搜索",class:"search-input",min:"1",max:"660"},null,512),[[In,s.searchNumber]]),x("button",{onClick:e[12]||(e[12]=(...u)=>i.clearSearch&&i.clearSearch(...u)),class:"btn btn-secondary"},"清除")]),x("div",Gk,[Ct(x("select",{"onUpdate:modelValue":e[13]||(e[13]=u=>s.filterStatus=u),class:"filter-select"},[...e[66]||(e[66]=[Oa('<option value="" data-v-50207fd5>所有状态</option><option value="掌握" data-v-50207fd5>掌握</option><option value="粗心" data-v-50207fd5>粗心</option><option value="概念模糊" data-v-50207fd5>概念模糊</option><option value="没思路" data-v-50207fd5>没思路</option><option value="其他" data-v-50207fd5>其他</option>',6)])],512),[[So,s.filterStatus]]),Ct(x("select",{"onUpdate:modelValue":e[14]||(e[14]=u=>s.filterDifficulty=u),class:"filter-select"},[...e[67]||(e[67]=[Oa('<option value="" data-v-50207fd5>所有难度</option><option value="1" data-v-50207fd5>1级</option><option value="2" data-v-50207fd5>2级</option><option value="3" data-v-50207fd5>3级</option><option value="4" data-v-50207fd5>4级</option><option value="5" data-v-50207fd5>5级</option>',6)])],512),[[So,s.filterDifficulty]])])]),x("div",Qk,[(le(!0),he(Et,null,ui(i.filteredQuestions,u=>(le(),he("div",{key:u.number,class:Fr(["question-card",{completed:u.status}])},[x("div",Jk,[x("span",Yk,ye(u.number),1),x("div",Xk,[x("button",{onClick:c=>i.openNoteModal(u.number),class:"btn btn-sm",title:"编辑笔记"}," 📝 ",8,Zk),x("button",{onClick:c=>i.openImageUpload(u.number),class:"btn btn-sm",title:"上传照片"}," 📷 ",8,eS),u.image?(le(),he("button",{key:0,onClick:c=>i.previewImage(u.image),class:"btn btn-sm",title:"预览照片"}," 👁️ ",8,tS)):Ie("",!0)])]),x("div",nS,[Ct(x("select",{"onUpdate:modelValue":c=>u.status=c,onChange:e[15]||(e[15]=(...c)=>i.saveData&&i.saveData(...c)),class:"status-select"},[...e[68]||(e[68]=[Oa('<option value="" data-v-50207fd5>未标记</option><option value="掌握" data-v-50207fd5>掌握</option><option value="粗心" data-v-50207fd5>粗心</option><option value="概念模糊" data-v-50207fd5>概念模糊</option><option value="没思路" data-v-50207fd5>没思路</option><option value="其他" data-v-50207fd5>其他</option>',6)])],40,rS),[[So,u.status]])]),x("div",sS,[e[69]||(e[69]=x("span",null,"难度:",-1)),x("div",iS,[(le(),he(Et,null,ui(5,c=>x("button",{key:c,onClick:l=>i.setDifficulty(u.number,c),class:Fr(["star-btn",{active:u.difficulty>=c}])}," ★ ",10,oS)),64))])]),u.note?(le(),he("div",uS,[x("div",{class:"note-preview-text",innerHTML:i.renderMarkdown(u.note.substring(0,100))},null,8,aS)])):Ie("",!0)],2))),128))]),s.showUploadModal?(le(),he("div",cS,[x("div",lS,[x("div",hS,[x("h3",null,"上传第 "+ye(s.currentQuestionNumber)+" 题照片",1),x("button",{onClick:e[16]||(e[16]=u=>s.showUploadModal=!1),class:"close-btn"},"×")]),x("div",{class:"upload-area",onDragover:e[18]||(e[18]=Lf(()=>{},["prevent"])),onDrop:e[19]||(e[19]=Lf((...u)=>i.handleDrop&&i.handleDrop(...u),["prevent"])),onClick:e[20]||(e[20]=(...u)=>i.triggerFileInput&&i.triggerFileInput(...u))},[x("input",{ref:"fileInput",type:"file",accept:"image/jpeg,image/png",onChange:e[17]||(e[17]=(...u)=>i.handleFileSelect&&i.handleFileSelect(...u)),style:{display:"none"}},null,544),e[70]||(e[70]=x("p",null,"点击或拖拽图片到此处上传",-1)),e[71]||(e[71]=x("p",null,"支持 JPG、PNG 格式",-1))],32),s.previewImageData?(le(),he("div",fS,[x("img",{src:s.previewImageData,alt:"预览"},null,8,dS),x("button",{onClick:e[21]||(e[21]=(...u)=>i.confirmUpload&&i.confirmUpload(...u)),class:"btn"},"确认上传"),x("button",{onClick:e[22]||(e[22]=u=>s.previewImageData=null),class:"btn btn-secondary"},"取消")])):Ie("",!0)])])):Ie("",!0),s.showPreviewModal?(le(),he("div",pS,[x("div",mS,[x("div",gS,[x("h3",null,"第 "+ye(s.currentQuestionNumber)+" 题照片",1),x("button",{onClick:e[23]||(e[23]=u=>s.showPreviewModal=!1),class:"close-btn"},"×")]),x("div",_S,[x("img",{src:s.previewImageData,alt:"预览"},null,8,yS)])])])):Ie("",!0),s.showNoteModal?(le(),he("div",bS,[x("div",ES,[x("div",vS,[x("h3",null,"第 "+ye(s.currentQuestionNumber)+" 题笔记",1),x("button",{onClick:e[24]||(e[24]=u=>s.showNoteModal=!1),class:"close-btn"},"×")]),x("div",wS,[Ct(x("textarea",{"onUpdate:modelValue":e[25]||(e[25]=u=>s.currentNote=u),class:"note-textarea",placeholder:"在此输入笔记内容，支持Markdown格式：\\n# 标题\\n- 列表\\n**粗体**\\n*斜体*\\n[链接](url)\\n```代码```",rows:"10"},null,512),[[In,s.currentNote]])]),x("div",TS,[x("button",{onClick:e[26]||(e[26]=(...u)=>i.saveNote&&i.saveNote(...u)),class:"btn"},"保存笔记"),x("button",{onClick:e[27]||(e[27]=u=>s.showNoteModal=!1),class:"btn btn-secondary"},"取消")])])])):Ie("",!0),s.showClearDataModal?(le(),he("div",IS,[x("div",AS,[x("div",CS,[e[72]||(e[72]=x("h3",null,"清除数据",-1)),x("button",{onClick:e[28]||(e[28]=u=>s.showClearDataModal=!1),class:"close-btn"},"×")]),e[73]||(e[73]=x("div",{class:"clear-data-content"},[x("p",{class:"warning-text"},"⚠️ 警告：此操作将清除当前用户的所有做题记录、照片和笔记，且无法恢复！"),x("p",null,"确定要清除当前用户的所有数据吗？")],-1)),x("div",xS,[x("button",{onClick:e[29]||(e[29]=(...u)=>i.clearAllData&&i.clearAllData(...u)),class:"btn btn-danger"},"确定清除"),x("button",{onClick:e[30]||(e[30]=u=>s.showClearDataModal=!1),class:"btn btn-secondary"},"取消")])])])):Ie("",!0),s.showUserModal?(le(),he("div",kS,[x("div",SS,[x("div",DS,[e[74]||(e[74]=x("h3",null,"用户管理",-1)),x("button",{onClick:e[31]||(e[31]=u=>s.showUserModal=!1),class:"close-btn"},"×")]),x("div",RS,[x("div",PS,[Ct(x("input",{"onUpdate:modelValue":e[32]||(e[32]=u=>s.newUserName=u),placeholder:"输入用户名",class:"user-input"},null,512),[[In,s.newUserName]]),x("button",{onClick:e[33]||(e[33]=(...u)=>i.createUser&&i.createUser(...u)),class:"btn"},"添加用户")]),x("div",FS,[(le(!0),he(Et,null,ui(i.users,(u,c)=>(le(),he("div",{key:c,class:"user-item"},[x("div",NS,[x("span",OS,ye(u.name),1),c===i.currentUserId?(le(),he("span",VS,"当前用户")):Ie("",!0)]),x("div",MS,[x("button",{onClick:l=>i.editUser(c),class:"btn btn-sm"},"编辑",8,LS),x("button",{onClick:l=>i.deleteUser(c),class:"btn btn-sm btn-danger",disabled:c===i.currentUserId||Object.keys(i.users).length<=1},"删除",8,US)])]))),128))])])])])):Ie("",!0),s.showEditUserModal?(le(),he("div",BS,[x("div",qS,[x("div",jS,[e[75]||(e[75]=x("h3",null,"编辑用户",-1)),x("button",{onClick:e[34]||(e[34]=u=>s.showEditUserModal=!1),class:"close-btn"},"×")]),x("div",zS,[Ct(x("input",{"onUpdate:modelValue":e[35]||(e[35]=u=>s.editingUserName=u),placeholder:"输入用户名",class:"user-input"},null,512),[[In,s.editingUserName]])]),x("div",HS,[x("button",{onClick:e[36]||(e[36]=(...u)=>i.saveEditUser&&i.saveEditUser(...u)),class:"btn"},"保存"),x("button",{onClick:e[37]||(e[37]=u=>s.showEditUserModal=!1),class:"btn btn-secondary"},"取消")])])])):Ie("",!0),s.showAuthModal?(le(),he("div",$S,[x("div",WS,[x("div",KS,[e[76]||(e[76]=x("h3",null,"登录",-1)),x("button",{onClick:e[38]||(e[38]=u=>s.showAuthModal=!1),class:"close-btn"},"×")]),x("div",GS,[s.authError?(le(),he("div",QS,ye(s.authError),1)):Ie("",!0),x("div",JS,[e[77]||(e[77]=x("label",null,"邮箱",-1)),Ct(x("input",{type:"email","onUpdate:modelValue":e[39]||(e[39]=u=>s.authForm.email=u),required:"",class:"auth-input"},null,512),[[In,s.authForm.email]])]),x("div",YS,[e[78]||(e[78]=x("label",null,"密码",-1)),Ct(x("input",{type:"password","onUpdate:modelValue":e[40]||(e[40]=u=>s.authForm.password=u),required:"",class:"auth-input"},null,512),[[In,s.authForm.password]])]),x("button",{onClick:e[41]||(e[41]=(...u)=>i.handleLogin&&i.handleLogin(...u)),class:"btn",disabled:s.authLoading},ye(s.authLoading?"登录中...":"登录"),9,XS),x("div",ZS,[e[79]||(e[79]=gc(" 还没有账户？ ",-1)),x("button",{onClick:e[42]||(e[42]=u=>{s.showAuthModal=!1,s.showRegisterModal=!0}),class:"link-btn"}," 注册 ")])])])])):Ie("",!0),s.showRegisterModal?(le(),he("div",eD,[x("div",tD,[x("div",nD,[e[80]||(e[80]=x("h3",null,"注册",-1)),x("button",{onClick:e[43]||(e[43]=u=>s.showRegisterModal=!1),class:"close-btn"},"×")]),x("div",rD,[s.authError?(le(),he("div",sD,ye(s.authError),1)):Ie("",!0),x("div",iD,[e[81]||(e[81]=x("label",null,"用户名",-1)),Ct(x("input",{type:"text","onUpdate:modelValue":e[44]||(e[44]=u=>s.authForm.username=u),required:"",class:"auth-input"},null,512),[[In,s.authForm.username]])]),x("div",oD,[e[82]||(e[82]=x("label",null,"邮箱",-1)),Ct(x("input",{type:"email","onUpdate:modelValue":e[45]||(e[45]=u=>s.authForm.email=u),required:"",class:"auth-input"},null,512),[[In,s.authForm.email]])]),x("div",uD,[e[83]||(e[83]=x("label",null,"密码",-1)),Ct(x("input",{type:"password","onUpdate:modelValue":e[46]||(e[46]=u=>s.authForm.password=u),required:"",class:"auth-input"},null,512),[[In,s.authForm.password]])]),x("button",{onClick:e[47]||(e[47]=(...u)=>i.handleRegister&&i.handleRegister(...u)),class:"btn",disabled:s.authLoading},ye(s.authLoading?"注册中...":"注册"),9,aD),x("div",cD,[e[84]||(e[84]=gc(" 已有账户？ ",-1)),x("button",{onClick:e[48]||(e[48]=u=>{s.showRegisterModal=!1,s.showAuthModal=!0}),class:"link-btn"}," 登录 ")])])])])):Ie("",!0)])}const hD=$x(Kx,[["render",lD],["__scopeId","data-v-50207fd5"]]);nb(hD).mount("#app");
